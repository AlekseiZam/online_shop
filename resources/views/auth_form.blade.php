        ...
        <div class="row justify-content-center">
             <div class="col-6 col-lg-3 gy-5">
                ...
                <ul class="nav nav-pills nav-justified mb-3" id="ex1" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link @if ($errors->has('loginName') or $errors->has('loginPassword') or session('auth')) active @else '' @endif" id="tab-login" data-bs-toggle="tab" href="#pills-login" role="tab"
                           aria-controls="pills-login">Авторизация</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link @if ($errors->has('email') or $errors->has('phone') or session('err')) active @else '' @endif" id="tab-register" data-bs-toggle="tab" href="#pills-register" role="tab"
                           aria-controls="pills-register">Регистрация</a>
                    </li>
                </ul>

                <div class="tab-content">
                    <div class="tab-pane fade @if ($errors->has('loginName') or $errors->has('loginPassword') or session('auth')) active show @else '' @endif" id="pills-login" role="tabpanel" aria-labelledby="tab-login">
                        <!-- Auth form -->
                        <form action="{{ route('check_auth') }}" method="POST">
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <input type="email" name="loginName" id="loginName" class="form-control" value="{{ old('loginName') }}" required>
                            </div>
